...
Private Function GetPixelColor(x As Long, y As Long, Optional HexCode As Boolean = False)
    Dim DC As Long
    ...
    If HexCode = True Then GetPixelColor = StrReverse$(Right$("000000" & Hex(GetPixelColor), 6))
